...
/**
 * The "include" section — the CQL keyword {@code include} as a concept, filed under
 ...
 * {@code [[term-include]]}): a Declaration of the Declarations family, Komet status "Not yet in
 * Komet".
 */
final class Include {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("include (CQL)");
        UUID fullyQualifiedName = set.uuidFor("include (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("include (CQL) regular name description");
        UUID definition = set.uuidFor("include (CQL) definition description");

        set.concept("include (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("include (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("include (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("include (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
