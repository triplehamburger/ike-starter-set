...
/**
 * The "ends" section — the CQL keyword {@code ends} as a concept, filed under
 ...
 * {@code [[term-ends]]}): a Timing Operator of the Data &amp; Timing Operators family, Komet
...
final class Ends {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("ends (CQL)");
        UUID fullyQualifiedName = set.uuidFor("ends (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("ends (CQL) regular name description");
        UUID definition = set.uuidFor("ends (CQL) definition description");

        set.concept("ends (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("ends (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("ends (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("ends (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
