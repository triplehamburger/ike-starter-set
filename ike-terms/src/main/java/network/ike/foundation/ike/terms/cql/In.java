...
/**
 * The "in" section — the CQL keyword {@code in} as a concept, filed under
 ...
 * {@code [[term-in]]}): a List/Interval Operator of the Data &amp; Timing Operators family,
...
final class In {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("in (CQL)");
        UUID fullyQualifiedName = set.uuidFor("in (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("in (CQL) regular name description");
        UUID definition = set.uuidFor("in (CQL) definition description");

        set.concept("in (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("in (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("in (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("in (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
