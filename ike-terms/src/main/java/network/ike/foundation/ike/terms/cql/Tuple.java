...
/**
 * The "Tuple" section — the CQL keyword {@code Tuple} as a concept, filed under
 ...
 * {@code [[term-Tuple]]}): a Type Name of the Types &amp; Literals family, Komet status "Not
 * yet in Komet".
 */
final class Tuple {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("Tuple (CQL)");
        UUID fullyQualifiedName = set.uuidFor("Tuple (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("Tuple (CQL) regular name description");
        UUID definition = set.uuidFor("Tuple (CQL) definition description");

        set.concept("Tuple (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("Tuple (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("Tuple (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("Tuple (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
