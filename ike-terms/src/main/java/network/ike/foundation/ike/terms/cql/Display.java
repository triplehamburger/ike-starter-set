...
/**
 * The "display" section — the CQL keyword {@code display} as a concept, filed under
 ...
 * {@code [[term-display]]}): a Declaration Modifier of the Declarations family, Komet status
 * "Not yet in Komet".
 */
final class Display {
