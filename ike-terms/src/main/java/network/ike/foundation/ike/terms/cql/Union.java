...
/**
 * The "union" section — the CQL keyword {@code union} as a concept, filed under
 ...
 * {@code [[term-union]]}): a List/Interval Operator of the Data &amp; Timing Operators family,
...
final class Union {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("union (CQL)");
        UUID fullyQualifiedName = set.uuidFor("union (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("union (CQL) regular name description");
        UUID definition = set.uuidFor("union (CQL) definition description");

        set.concept("union (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("union (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("union (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("union (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
