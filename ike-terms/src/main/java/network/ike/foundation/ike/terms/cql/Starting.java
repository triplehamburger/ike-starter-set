...
/**
 * The "starting" section — the CQL keyword {@code starting} as a concept, filed under
 ...
 * {@code [[term-starting]]}): a Query Clause of the Query &amp; Control Flow family, Komet
...
final class Starting {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("starting (CQL)");
        UUID fullyQualifiedName = set.uuidFor("starting (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("starting (CQL) regular name description");
        UUID definition = set.uuidFor("starting (CQL) definition description");

        set.concept("starting (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("starting (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("starting (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("starting (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
