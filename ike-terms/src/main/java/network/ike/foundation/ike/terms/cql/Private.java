...
/**
 * The "private" section — the CQL keyword {@code private} as a concept, filed under
 ...
 * {@code [[term-private]]}): a Access Modifier of the Declarations family, Komet status "Not
 * yet in Komet".
 */
final class Private {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("private (CQL)");
        UUID fullyQualifiedName = set.uuidFor("private (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("private (CQL) regular name description");
        UUID definition = set.uuidFor("private (CQL) definition description");

        set.concept("private (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("private (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("private (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("private (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
