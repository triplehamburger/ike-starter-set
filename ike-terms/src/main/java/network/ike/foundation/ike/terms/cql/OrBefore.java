...
/**
 * The "or before" section — the CQL keyword {@code or before} as a concept, filed under
 ...
 * {@code [[term-or-before]]}): a Timing Operator of the Data &amp; Timing Operators family,
 * Komet status "Not yet in Komet".
 */
final class OrBefore {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("or before (CQL)");
        UUID fullyQualifiedName = set.uuidFor("or before (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("or before (CQL) regular name description");
        UUID definition = set.uuidFor("or before (CQL) definition description");

        set.concept("or before (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("or before (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("or before (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("or before (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
