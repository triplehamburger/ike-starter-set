...
/**
 * The "except" section — the CQL keyword {@code except} as a concept, filed under
 ...
 * {@code [[term-except]]}): a List/Interval Operator of the Data &amp; Timing Operators family,
...
final class Except {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("except (CQL)");
        UUID fullyQualifiedName = set.uuidFor("except (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("except (CQL) regular name description");
        UUID definition = set.uuidFor("except (CQL) definition description");

        set.concept("except (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("except (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("except (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("except (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
