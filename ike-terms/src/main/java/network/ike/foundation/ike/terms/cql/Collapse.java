...
final class Collapse {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("collapse (CQL)");
        UUID fullyQualifiedName = set.uuidFor("collapse (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("collapse (CQL) regular name description");
        UUID definition = set.uuidFor("collapse (CQL) definition description");

        set.concept("collapse (CQL)", PublicIds.of(concept)).at(inception)
