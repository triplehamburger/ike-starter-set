...
final class Function {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("function (CQL)");
        UUID fullyQualifiedName = set.uuidFor("function (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("function (CQL) regular name description");
        UUID definition = set.uuidFor("function (CQL) definition description");

        set.concept("function (CQL)", PublicIds.of(concept)).at(inception)
