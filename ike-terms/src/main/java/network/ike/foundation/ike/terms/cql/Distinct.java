...
/**
 * The "distinct" section — the CQL keyword {@code distinct} as a concept, filed under
 ...
 * {@code [[term-distinct]]}): a List/Interval Operator of the Data &amp; Timing Operators
...
final class Distinct {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("distinct (CQL)");
        UUID fullyQualifiedName = set.uuidFor("distinct (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("distinct (CQL) regular name description");
        UUID definition = set.uuidFor("distinct (CQL) definition description");

        set.concept("distinct (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("distinct (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("distinct (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("distinct (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
