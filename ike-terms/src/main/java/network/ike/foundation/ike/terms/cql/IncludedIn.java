...
final class IncludedIn {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("included in (CQL)");
        UUID fullyQualifiedName = set.uuidFor("included in (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("included in (CQL) regular name description");
        UUID definition = set.uuidFor("included in (CQL) definition description");

        set.concept("included in (CQL)", PublicIds.of(concept)).at(inception)
