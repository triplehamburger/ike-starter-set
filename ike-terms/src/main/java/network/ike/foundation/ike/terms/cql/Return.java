...
/**
 * The "return" section — the CQL keyword {@code return} as a concept, filed under
 ...
 * {@code [[term-return]]}): a Query Clause of the Query &amp; Control Flow family, Komet status
 * "Not yet in Komet".
 */
final class Return {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("return (CQL)");
        UUID fullyQualifiedName = set.uuidFor("return (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("return (CQL) regular name description");
        UUID definition = set.uuidFor("return (CQL) definition description");

        set.concept("return (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("return (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("return (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("return (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
