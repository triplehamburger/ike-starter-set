...
/**
 * The "mod" section — the CQL keyword {@code mod} as a concept, filed under
 ...
 * {@code [[term-mod]]}): a Arithmetic Operator of the Core Operators family, Komet status "Not
 * yet in Komet".
 */
final class Mod {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("mod (CQL)");
        UUID fullyQualifiedName = set.uuidFor("mod (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("mod (CQL) regular name description");
        UUID definition = set.uuidFor("mod (CQL) definition description");

        set.concept("mod (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("mod (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("mod (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("mod (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
