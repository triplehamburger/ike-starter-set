...
/**
 * The "starts" section — the CQL keyword {@code starts} as a concept, filed under
 ...
 * {@code [[term-starts]]}): a Timing Operator of the Data &amp; Timing Operators family, Komet
...
final class Starts {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("starts (CQL)");
        UUID fullyQualifiedName = set.uuidFor("starts (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("starts (CQL) regular name description");
        UUID definition = set.uuidFor("starts (CQL) definition description");

        set.concept("starts (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("starts (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("starts (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("starts (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
