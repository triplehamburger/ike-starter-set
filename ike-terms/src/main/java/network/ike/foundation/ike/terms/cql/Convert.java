...
/**
 * The "convert" section — the CQL keyword {@code convert} as a concept, filed under
 ...
 * {@code [[term-convert]]}): a Type Operator of the Core Operators family, Komet status "Not
 * yet in Komet".
 */
final class Convert {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("convert (CQL)");
        UUID fullyQualifiedName = set.uuidFor("convert (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("convert (CQL) regular name description");
        UUID definition = set.uuidFor("convert (CQL) definition description");

        set.concept("convert (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("convert (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("convert (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("convert (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
