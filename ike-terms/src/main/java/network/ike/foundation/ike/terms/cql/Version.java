...
/**
 * The "version" section — the CQL keyword {@code version} as a concept, filed under
 ...
 * {@code [[term-version]]}): a Declaration Modifier of the Declarations family, Komet status
 * "Not yet in Komet".
 */
final class Version {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("version (CQL)");
        UUID fullyQualifiedName = set.uuidFor("version (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("version (CQL) regular name description");
        UUID definition = set.uuidFor("version (CQL) definition description");

        set.concept("version (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("version (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("version (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("version (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
