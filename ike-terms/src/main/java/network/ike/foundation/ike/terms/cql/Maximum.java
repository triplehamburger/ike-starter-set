...
/**
 * The "maximum" section — the CQL keyword {@code maximum} as a concept, filed under
 ...
 * {@code [[term-maximum]]}): a Arithmetic Operator of the Core Operators family, Komet status
 * "Not yet in Komet".
 */
final class Maximum {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("maximum (CQL)");
        UUID fullyQualifiedName = set.uuidFor("maximum (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("maximum (CQL) regular name description");
        UUID definition = set.uuidFor("maximum (CQL) definition description");

        set.concept("maximum (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("maximum (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("maximum (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("maximum (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
