...
/**
 * The "occurs" section — the CQL keyword {@code occurs} as a concept, filed under
 ...
 * {@code [[term-occurs]]}): a Timing Operator of the Data &amp; Timing Operators family, Komet
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("occurs (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(definition), IkeTerm.ENGLISH_LANGUAGE,
                        "Optional word that may appear anywhere ‘starts’ or ‘ends’ can appear"
                        + " in a timing phrase, purely to make it read more"
                        + " naturally.\n\nExample: \"Condition\" occurs during"
                ...
                .statedAxioms(PublicIds.of(set.uuidFor("occurs (CQL) stated axioms")), leb -> leb.NecessarySet(leb.And(leb.ConceptAxiom(set.conceptRef("Legacy (IkeFoundation)")))))
