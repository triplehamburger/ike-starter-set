...
/**
 * The "library" section — the CQL keyword {@code library} as a concept, filed under
 ...
 * {@code [[term-library]]}): a Declaration of the Declarations family, Komet status "Not yet in
 * Komet".
 */
final class Library {
