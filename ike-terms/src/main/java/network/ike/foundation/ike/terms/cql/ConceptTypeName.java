...
/**
 * The "Concept" section — the CQL keyword {@code Concept} as a concept, filed under
 ...
 * {@code [[term-Concept]]}): a Type Name of the Types &amp; Literals family, Komet status "Not
 * yet in Komet".
 */
final class ConceptTypeName {

    private ConceptTypeName() {
    }
