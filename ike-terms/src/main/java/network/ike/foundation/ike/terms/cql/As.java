...
/**
 * The "as" section — the CQL keyword {@code as} as a concept, filed under
 ...
 * {@code [[term-as]]}): a Type Operator of the Core Operators family, Komet status "Not yet in
 * Komet".
 */
final class As {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("as (CQL)");
        UUID fullyQualifiedName = set.uuidFor("as (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("as (CQL) regular name description");
        UUID definition = set.uuidFor("as (CQL) definition description");

        set.concept("as (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("as (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("as (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("as (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
