...
/**
 * The "within" section — the CQL keyword {@code within} as a concept, filed under
 ...
 * {@code [[term-within]]}): a Timing Operator of the Data &amp; Timing Operators family, Komet
...
final class Within {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("within (CQL)");
        UUID fullyQualifiedName = set.uuidFor("within (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("within (CQL) regular name description");
        UUID definition = set.uuidFor("within (CQL) definition description");

        set.concept("within (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("within (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("within (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("within (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
