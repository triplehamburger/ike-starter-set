...
/**
 * The "desc" section — the CQL keyword {@code desc} as a concept, filed under
 ...
 * {@code [[term-desc]]}): a Sort Modifier of the Query &amp; Control Flow family, Komet status
 * "Not yet in Komet".
 */
final class Desc {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("desc (CQL)");
        UUID fullyQualifiedName = set.uuidFor("desc (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("desc (CQL) regular name description");
        UUID definition = set.uuidFor("desc (CQL) definition description");

        set.concept("desc (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("desc (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("desc (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("desc (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
