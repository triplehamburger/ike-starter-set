...
/**
 * The "time" section — the CQL keyword {@code time} as a concept, filed under
 ...
 * {@code [[term-time]]}): a Extraction Operator of the Data &amp; Timing Operators family,
    ...
    static void compose(KnowledgeSet set) {
        ...
        set.concept("time (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semantic(IkeTerm.DESCRIPTION_PATTERN, PublicIds.of(definition), IkeTerm.ENGLISH_LANGUAGE,
                        ...
                        + " X’.\n\nExample: time from \"EncounterDateTime\"\n\nCQL category: Data"
