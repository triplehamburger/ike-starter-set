...
/**
 * The "or after" section — the CQL keyword {@code or after} as a concept, filed under
 ...
 * {@code [[term-or-after]]}): a Timing Operator of the Data &amp; Timing Operators family,
...
final class OrAfter {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("or after (CQL)");
        UUID fullyQualifiedName = set.uuidFor("or after (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("or after (CQL) regular name description");
        UUID definition = set.uuidFor("or after (CQL) definition description");

        set.concept("or after (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("or after (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("or after (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("or after (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
