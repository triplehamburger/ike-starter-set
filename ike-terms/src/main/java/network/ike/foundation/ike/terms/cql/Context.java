...
final class Context {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("context (CQL)");
        UUID fullyQualifiedName = set.uuidFor("context (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("context (CQL) regular name description");
        UUID definition = set.uuidFor("context (CQL) definition description");

        set.concept("context (CQL)", PublicIds.of(concept)).at(inception)
