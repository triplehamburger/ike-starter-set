...
/**
 * The "properly" section — the CQL keyword {@code properly} as a concept, filed under
 ...
 * {@code [[term-properly]]}): a List/Interval Operator of the Data &amp; Timing Operators
...
final class Properly {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("properly (CQL)");
        UUID fullyQualifiedName = set.uuidFor("properly (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("properly (CQL) regular name description");
        UUID definition = set.uuidFor("properly (CQL) definition description");

        set.concept("properly (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("properly (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("properly (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("properly (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
