...
/**
 * The "cast" section — the CQL keyword {@code cast} as a concept, filed under
 ...
 * {@code [[term-cast]]}): a Type Operator of the Core Operators family, Komet status "Not yet
 * in Komet".
 */
final class Cast {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("cast (CQL)");
        UUID fullyQualifiedName = set.uuidFor("cast (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("cast (CQL) regular name description");
        UUID definition = set.uuidFor("cast (CQL) definition description");

        set.concept("cast (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("cast (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("cast (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("cast (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
