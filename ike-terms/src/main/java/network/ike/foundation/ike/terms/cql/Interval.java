...
/**
 * The "Interval" section — the CQL keyword {@code Interval} as a concept, filed under
 ...
 * {@code [[term-Interval]]}): a Type Name of the Types &amp; Literals family, Komet status
 * "Related concept in Komet".
 */
final class Interval {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("Interval (CQL)");
        UUID fullyQualifiedName = set.uuidFor("Interval (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("Interval (CQL) regular name description");
        UUID definition = set.uuidFor("Interval (CQL) definition description");

        set.concept("Interval (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("Interval (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("Interval (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("Interval (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
