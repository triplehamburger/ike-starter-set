...
/**
 * The "public" section — the CQL keyword {@code public} as a concept, filed under
 ...
 * {@code [[term-public]]}): a Access Modifier of the Declarations family, Komet status "Not yet
 * in Komet".
 */
final class Public {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("public (CQL)");
        UUID fullyQualifiedName = set.uuidFor("public (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("public (CQL) regular name description");
        UUID definition = set.uuidFor("public (CQL) definition description");

        set.concept("public (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("public (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("public (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("public (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
