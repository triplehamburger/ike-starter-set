...
/**
 * The "intersect" section — the CQL keyword {@code intersect} as a concept, filed under
 ...
 * {@code [[term-intersect]]}): a List/Interval Operator of the Data &amp; Timing Operators
...
final class Intersect {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("intersect (CQL)");
        UUID fullyQualifiedName = set.uuidFor("intersect (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("intersect (CQL) regular name description");
        UUID definition = set.uuidFor("intersect (CQL) definition description");

        set.concept("intersect (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("intersect (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("intersect (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("intersect (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
