...
/**
 * The "meets" section — the CQL keyword {@code meets} as a concept, filed under
 ...
 * {@code [[term-meets]]}): a Timing Operator of the Data &amp; Timing Operators family, Komet
...
final class Meets {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("meets (CQL)");
        UUID fullyQualifiedName = set.uuidFor("meets (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("meets (CQL) regular name description");
        UUID definition = set.uuidFor("meets (CQL) definition description");

        set.concept("meets (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("meets (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("meets (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("meets (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
