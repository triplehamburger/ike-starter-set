...
/**
 * The "xor" section — the CQL keyword {@code xor} as a concept, filed under
 ...
 * {@code [[term-xor]]}): a Logical Operator of the Core Operators family, Komet status "Not yet
 * in Komet".
 */
final class Xor {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("xor (CQL)");
        UUID fullyQualifiedName = set.uuidFor("xor (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("xor (CQL) regular name description");
        UUID definition = set.uuidFor("xor (CQL) definition description");

        set.concept("xor (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("xor (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("xor (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("xor (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
