...
/**
 * The "div" section — the CQL keyword {@code div} as a concept, filed under
 ...
 * {@code [[term-div]]}): a Arithmetic Operator of the Core Operators family, Komet status "Not
 * yet in Komet".
 */
final class Div {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("div (CQL)");
        UUID fullyQualifiedName = set.uuidFor("div (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("div (CQL) regular name description");
        UUID definition = set.uuidFor("div (CQL) definition description");

        set.concept("div (CQL)", PublicIds.of(concept)).at(inception)
                ...
                .semanticOn(PublicIds.of(fullyQualifiedName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("div (CQL) fully qualified name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(regularName), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("div (CQL) regular name US dialect")), IkeTerm.PREFERRED)  // dialect pref
                .semanticOn(PublicIds.of(definition), IkeTerm.US_DIALECT_PATTERN, PublicIds.of(set.uuidFor("div (CQL) definition US dialect")), IkeTerm.PREFERRED)  // dialect pref
                ;
