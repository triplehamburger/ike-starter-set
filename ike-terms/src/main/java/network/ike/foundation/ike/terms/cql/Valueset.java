...
final class Valueset {
    ...
    static void compose(KnowledgeSet set) {
        ...
        UUID concept = set.uuidFor("valueset (CQL)");
        UUID fullyQualifiedName = set.uuidFor("valueset (CQL) fully qualified name description");
        UUID regularName = set.uuidFor("valueset (CQL) regular name description");
        UUID definition = set.uuidFor("valueset (CQL) definition description");

        set.concept("valueset (CQL)", PublicIds.of(concept)).at(inception)
